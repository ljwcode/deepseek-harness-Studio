...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/connection-desktop': { kind: 'none', reason: 'Desktop IPC carrier moves already-composed envelopes between renderer and host and registers nothing model-facing.' },
  ...
  'packages/bundle/desktop-app': { kind: 'indirect', reason: 'The bundle patch only restates the persona and mounts/disable rows; each mounted package owns its model-facing behavior.' },
