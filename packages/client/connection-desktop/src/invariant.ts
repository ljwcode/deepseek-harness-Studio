...
/**
 * No runtime invariant: the desktop carrier moves already-validated envelopes
 * between renderer and host, owns no mutable cross-plugin relation, and its
 * reconnect/stream sequencing is exercised by package behavior specs.
 */
