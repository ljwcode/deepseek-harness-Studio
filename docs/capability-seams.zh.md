...
flowchart LR
  ...
  svc_desktopRuntime["ctx.desktopRuntime<br/>Desktop client graph host"]
  ...
  svc_desktopRuntime --> pkg_desktop_app
...
| `ctx.desktopRuntime` | `core` | [`desktop-app`](../packages/bundle/desktop-app) | - | [`desktop-app`](../packages/bundle/desktop-app) | - | 从已挂载的 dsh.client 清单组合桌面启动图，并为 IPC 桥读取构建好的客户端 bundle。 |
