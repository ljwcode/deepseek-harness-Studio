...
- `@deepseek-ai/dsh-desktop-runtime-fixture` — requires `tools` · `approval` · `userQuestions` · `jobs` ([`packages/test-support/desktop-runtime-fixture/src/index.ts`](../packages/test-support/desktop-runtime-fixture/src/index.ts))
